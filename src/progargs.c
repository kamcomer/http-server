...
// TODO: Not sure if I like how a ProgramArgument is allocated on the heap and then later
// deallocated
...
static const ArgumentDefinition* get_argument_definition(const char* flag,
                                                         ArgumentDefinitions arg_defs) {
